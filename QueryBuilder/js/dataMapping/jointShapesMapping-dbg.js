...
(function (joint, util) {
	...
	joint.shapes.standard.BorderedRecord.define('mapping.Constant', {
		...
		getTools: function () {
			return [{
				action: 'remove',
				content: warning('Remove Constant')
			}];
		},
	...
	joint.shapes.standard.HeaderedRecord.define('mapping.GetDate', {
		...
		getTools: function () {
			return [{
				action: 'remove',
				content: warning('Remove GetDate')
			}];
		},
	...
	joint.shapes.standard.HeaderedRecord.define('mapping.Record', {
		...
		getItemTools: function () {
			return [{
				...
				action: 'add-next-sibling',
				content: 'Add Next Sibling'
			}, {
				action: 'add-prev-sibling',
				content: 'Add Prev Sibling'
			}, {
				action: 'remove',
				content: warning('Remove Item')
			}];
		},
	...
	joint.shapes.standard.HeaderedRecord.define('mapping.Join', {
		itemHeight: 20,
		itemOffset: 15,
		itemMinLabelWidth: 70,
		padding: {
		...
		getItemTools: function () {
			return [{
				action: '',
				content: warning('Select a join type')
			}, {
				action: 'on-inner-join',
				content: 'inner join'
			}, {
				action: 'on-full-join',
				content: 'full join'
	...
	joint.shapes.standard.HeaderedRecord.define('mapping.Output', {
		itemHeight: 20,
		itemOffset: 15,
		itemMinLabelWidth: 70,
		padding: {
	...
	joint.shapes.mapping.JoinView = joint.shapes.standard.RecordView;
